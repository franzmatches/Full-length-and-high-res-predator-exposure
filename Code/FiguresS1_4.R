...
png(file = "Results/figures/supplementary_figures/figure_S1a.png",
...
png(file = "Results/figures/supplementary_figures/figure_S1b.png",
...
ggsave(
  brms::pp_check(brms_id_weibullk8) + 
    theme_bw(),
  filename = "Results/figures/supplementary_figures/figure_S3.png",
  width = 4,height = 4)
