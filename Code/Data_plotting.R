...
ggsave("mean speed_reps_points_mean.pdf", units="in", width=16, height=10) 
...
ggsave("mean mean_length_reps_points_mean.pdf", units="in", width=16, height=10) 
...
ggsave("mean max_length_reps_points_mean.pdf", units="in", width=16, height=10) 
