...
#write csv
write.csv(data_homalozoon_clean, "data_homalozoon_IDs_clean.csv", row.names = FALSE)

#reload data to save in rdata format
data_hom<-read.csv("homalozoon_data_IDs_clean.csv")

saveRDS(data_hom, file = "homalozoon_data_IDs_clean.RDS")
